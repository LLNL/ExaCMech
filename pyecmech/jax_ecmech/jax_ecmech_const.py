...
class HistClass:
    def __init__(self,
        ...
        self.ind_hist_elas_strain_end = self.ind_hist_elas_strain + NTVEC

        self.ind_hist_quats = self.num_hist_auxillary + NTVEC
        self.ind_hist_quats_end = self.ind_hist_quats + QDIM

        self.ind_hist_hard = self.num_hist_auxillary + NTVEC + QDIM
