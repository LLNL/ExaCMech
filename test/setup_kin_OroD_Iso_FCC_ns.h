{
   ...
   std::vector<double> paramsThese {
      ...
      gam_ro, wrD,
      fD, c_1, tau_a, p, q, c2 };
   std::vector<double> inter_mat(144, 1.0);
   std::vector<double> paramEnd {
   ...
   paramsThese.insert(paramsThese.end(), inter_mat.begin(), inter_mat.end());
   paramsThese.insert(paramsThese.end(), paramEnd.begin(), paramEnd.end());
#ifdef STACK_PARAMS
